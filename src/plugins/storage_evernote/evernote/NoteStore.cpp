...
uint32_t NoteStore_listNotebooks_result::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<evernote::edam::Notebook> ::const_iterator _iter117;
...
uint32_t NoteStore_listTags_result::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRUCT, this->success.size());
      std::vector<evernote::edam::Tag> ::const_iterator _iter128;
...
uint32_t NoteStore_listTagsByNotebook_result::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRUCT, this->success.size());
      std::vector<evernote::edam::Tag> ::const_iterator _iter139;
...
uint32_t NoteStore_listSearches_result::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRUCT, this->success.size());
      std::vector<evernote::edam::SavedSearch> ::const_iterator _iter150;
        ...
        if (ftype == apache::thrift::protocol::T_LIST) {
          {
            ...
            this->noteGuids.resize(_size167);
            uint32_t _i171;
            for (_i171 = 0; _i171 < _size167; ++_i171)
            {
              xfer += iprot->readString(this->noteGuids[_i171]);
            }
            iprot->readListEnd();
          }
...
uint32_t NoteStore_expungeNotes_args::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("noteGuids", apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<evernote::edam::Guid> ::const_iterator _iter172;
    for (_iter172 = this->noteGuids.begin(); _iter172 != this->noteGuids.end(); ++_iter172)
    {
...
uint32_t NoteStore_expungeNotes_pargs::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRING, (*(this->noteGuids)).size());
    std::vector<evernote::edam::Guid> ::const_iterator _iter173;
    for (_iter173 = (*(this->noteGuids)).begin(); _iter173 != (*(this->noteGuids)).end(); ++_iter173)
    {
...
uint32_t NoteStore_getAds_result::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRUCT, this->success.size());
      std::vector<evernote::edam::Ad> ::const_iterator _iter179;
...
uint32_t NoteStore_listSharedNotebooks_result::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRUCT, this->success.size());
      std::vector<evernote::edam::SharedNotebook> ::const_iterator _iter190;
        ...
        if (ftype == apache::thrift::protocol::T_LIST) {
          {
            ...
            this->sharedNotebookIds.resize(_size196);
            uint32_t _i200;
            for (_i200 = 0; _i200 < _size196; ++_i200)
            {
              xfer += iprot->readI64(this->sharedNotebookIds[_i200]);
            }
            iprot->readListEnd();
          }
...
uint32_t NoteStore_expungeSharedNotebooks_args::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("sharedNotebookIds", apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter201 = this->sharedNotebookIds.begin(); _iter201 != this->sharedNotebookIds.end(); ++_iter201)
    {
...
uint32_t NoteStore_expungeSharedNotebooks_pargs::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(apache::thrift::protocol::T_I64, (*(this->sharedNotebookIds)).size());
    std::vector<int64_t> ::const_iterator _iter202;
    for (_iter202 = (*(this->sharedNotebookIds)).begin(); _iter202 != (*(this->sharedNotebookIds)).end(); ++_iter202)
    {
...
uint32_t NoteStore_listLinkedNotebooks_result::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRUCT, this->success.size());
      std::vector<evernote::edam::LinkedNotebook> ::const_iterator _iter208;
...
uint32_t NoteStore_expungeLinkedNotebook_args::read(apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->linkedNotebookId);
...
uint32_t NoteStore_expungeLinkedNotebook_args::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeString(this->authenticationToken);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("linkedNotebookId", apache::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->linkedNotebookId);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
...
void NoteStoreClient::updateLinkedNotebook(evernote::edam::LinkedNotebook& _return, const std::string& authenticationToken, const evernote::edam::LinkedNotebook& linkedNotebook)
{
  send_updateLinkedNotebook(authenticationToken, linkedNotebook);
  recv_updateLinkedNotebook(_return);
}
...
void NoteStoreClient::recv_updateLinkedNotebook(evernote::edam::LinkedNotebook& _return)
{
...
int32_t NoteStoreClient::expungeLinkedNotebook(const std::string& authenticationToken, const int64_t linkedNotebookId)
{
  send_expungeLinkedNotebook(authenticationToken, linkedNotebookId);
  return recv_expungeLinkedNotebook();
}

void NoteStoreClient::send_expungeLinkedNotebook(const std::string& authenticationToken, const int64_t linkedNotebookId)
{
  int32_t cseqid = 0;
...
void NoteStoreProcessor::process_updateLinkedNotebook(int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot)
{
  ...
  try {
    iface_->updateLinkedNotebook(result.success, args.authenticationToken, args.linkedNotebook);
    result.__isset.success = true;
  } catch (evernote::edam::EDAMUserException &userException) {
    result.userException = userException;
    result.__isset.userException = true;
