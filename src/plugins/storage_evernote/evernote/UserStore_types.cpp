...
const char* AuthenticationResult::ascii_fingerprint = "F9AE5F5A08F8D239F5B72411F3F8C429";
const uint8_t AuthenticationResult::binary_fingerprint[16] = {0xF9,0xAE,0x5F,0x5A,0x08,0xF8,0xD2,0x39,0xF5,0xB7,0x24,0x11,0xF3,0xF8,0xC4,0x29};
