...
const char* UserAttributes::ascii_fingerprint = "403ADED353066420B5EAA1E33867A8BC";
const uint8_t UserAttributes::binary_fingerprint[16] = {0x40,0x3A,0xDE,0xD3,0x53,0x06,0x64,0x20,0xB5,0xEA,0xA1,0xE3,0x38,0x67,0xA8,0xBC};
...
const char* Accounting::ascii_fingerprint = "17421BA589A652E287250D6DFF8D25E1";
const uint8_t Accounting::binary_fingerprint[16] = {0x17,0x42,0x1B,0xA5,0x89,0xA6,0x52,0xE2,0x87,0x25,0x0D,0x6D,0xFF,0x8D,0x25,0xE1};
...
const char* User::ascii_fingerprint = "ED929C5F1884A862976CD120CCB0E4CE";
const uint8_t User::binary_fingerprint[16] = {0xED,0x92,0x9C,0x5F,0x18,0x84,0xA8,0x62,0x97,0x6C,0xD1,0x20,0xCC,0xB0,0xE4,0xCE};
...
const char* NoteAttributes::ascii_fingerprint = "FCEACAC5E6423F30EC4ECA84F833084F";
const uint8_t NoteAttributes::binary_fingerprint[16] = {0xFC,0xEA,0xCA,0xC5,0xE6,0x42,0x3F,0x30,0xEC,0x4E,0xCA,0x84,0xF8,0x33,0x08,0x4F};
...
const char* Note::ascii_fingerprint = "4436B6046C67840B3AE90406ACF39CA3";
const uint8_t Note::binary_fingerprint[16] = {0x44,0x36,0xB6,0x04,0x6C,0x67,0x84,0x0B,0x3A,0xE9,0x04,0x06,0xAC,0xF3,0x9C,0xA3};
...
const char* Notebook::ascii_fingerprint = "229D750AF1F671E43C0C284E74A2DFB1";
const uint8_t Notebook::binary_fingerprint[16] = {0x22,0x9D,0x75,0x0A,0xF1,0xF6,0x71,0xE4,0x3C,0x0C,0x28,0x4E,0x74,0xA2,0xDF,0xB1};
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == apache::thrift::protocol::T_I32) {
          ...
          this->format = (QueryFormat)ecast33;
...
const char* Ad::ascii_fingerprint = "1D44D2C6F1EFFA11DD31E8A7F4063DD3";
const uint8_t Ad::binary_fingerprint[16] = {0x1D,0x44,0xD2,0xC6,0xF1,0xEF,0xFA,0x11,0xDD,0x31,0xE8,0xA7,0xF4,0x06,0x3D,0xD3};
...
const char* LinkedNotebook::ascii_fingerprint = "266757B9EEA2E1AC09A9BA90AB46F4D7";
const uint8_t LinkedNotebook::binary_fingerprint[16] = {0x26,0x67,0x57,0xB9,0xEE,0xA2,0xE1,0xAC,0x09,0xA9,0xBA,0x90,0xAB,0x46,0xF4,0xD7};
