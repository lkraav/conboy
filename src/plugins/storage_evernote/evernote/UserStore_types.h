...
class PublicUserInfo {
 public:
  ...
  struct __isset {
    __isset() : privilege(false), username(false) {}
    bool privilege;
    bool username;
  } __isset;
...
class AuthenticationResult {
 public:
  ...
  static const char* ascii_fingerprint; // = "F9AE5F5A08F8D239F5B72411F3F8C429";
  static const uint8_t binary_fingerprint[16]; // = {0xF9,0xAE,0x5F,0x5A,0x08,0xF8,0xD2,0x39,0xF5,0xB7,0x24,0x11,0xF3,0xF8,0xC4,0x29};
  ...
  struct __isset {
    __isset() : user(false), publicUserInfo(false) {}
    bool user;
    bool publicUserInfo;
  } __isset;
