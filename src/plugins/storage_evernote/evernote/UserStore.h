...
class UserStore_checkVersion_args {
 public:
  ...
  UserStore_checkVersion_args() : clientName(""), edamVersionMajor(1), edamVersionMinor(13) {
  }
  ...
  struct __isset {
    __isset() : clientName(false), edamVersionMajor(false), edamVersionMinor(false) {}
    bool clientName;
...
class UserStore_authenticate_args {
 public:
  ...
  struct __isset {
    __isset() : username(false), password(false), consumerKey(false), consumerSecret(false) {}
    bool username;
    bool password;
    bool consumerKey;
    bool consumerSecret;
...
class UserStore_getPublicUserInfo_result {
 public:
  ...
  struct __isset {
    __isset() : success(false), notFoundException(false), systemException(false), userException(false) {}
    bool success;
