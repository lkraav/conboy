...
match_error (gint errcode)
{
  switch (errcode)
    ...
    case PCRE_ERROR_UNKNOWN_NODE:
      return ("internal error or corrupted object");
...
static const gchar *
compile_error (gint errcode,
	       const gchar *default_msg)
{
  switch (errcode)
    {
    case 1:
    ...
    case 37:
      return ("case changing escapes are not allowed here");
    case 4:
    ...
    case 24:
      return ("unrecognized character after (?<");
    case 41:
      return ("unrecognized character after (?P");
    case 13:
    ...
    case 40:
      return ("recursive call could loop indefinitely");
    case 42:
      return ("missing terminator in subpattern name");
    case 43:
      return ("two named subpatterns have the same name");
    case 46:
      return ("malformed \\P or \\p sequence");
    case 47:
      return ("unknown property name after \\P or \\p");
    case 48:
      return ("subpattern name is too long (maximum 32 characters)");
    case 49:
      return ("too many named subpatterns (maximum 10,000)");
    case 51:
      return ("octal value is greater than \\377");
    case 54:
      return ("DEFINE group contains more than one branch");
    case 55:
      return ("repeating a DEFINE group is not allowed");
    case 56:
      return ("inconsistent NEWLINE options");
    case 57:
      return ("\\g is not followed by a braced name or an optionally "
	       "braced non-zero number");
    case 11:
      return ("unexpected repeat");
    case 23:
      return ("code overflow");
    case 52:
      return ("overran compiling workspace");
    case 53:
      return ("previously-checked referenced subpattern not found");
    case 16:
 ...
 * 
 * The error code of @error is G_REGEX_ERROR_COMPILE, but
 * future versions will add more specific error codes.
 * 
	     ...
	     GError             **error)
{
  ...
  /* compile the pattern */
  re = pcre_compile2 (pattern, compile_options, &errcode, &errmsg,
		      &erroffset, NULL);
  ...
  if (re == NULL)
    {
      ...
      /* Get the translatable error message instead of just using the
       * English one */
      errmsg = compile_error (errcode, errmsg);
